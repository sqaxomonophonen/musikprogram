...
#define TILES \
	...
	DEF_TILE3x3(rbox_fancy, boxes, 1.0, 1.0, (Circle(1.0) && !Circle(0.9)) || (Circle(0.7) && !Circle(0.4))) \
	DEF_TILE3x3(rbox, boxes, 1.0, 1.0, Circle(1.0)) \
	DEF_TILE3x3(rbox_border, boxes, 1.0, 1.0, (Circle(1.0) && !Circle(0.85)))
